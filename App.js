...
export default function App() {
    ...
    const Btn = ({title, type}) => (
        ...
        style={{padding: 10, borderRadius: 10, elevation: 2, backgroundColor: getColor(colors.light1, colors.dark2), height: 70, width: 70, margin: 16}} >
            <Text style={{fontSize: 37, color: 'black', textAlignVertical: 'center', textAlign: 'center', color: getBtnColor(type) }}>{title}</Text>
        </TouchableOpacity>
    )
